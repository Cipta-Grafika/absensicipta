      ...
      @foreach ($divisions as $division)
        <tr>
          ...
          <td class="relative flex justify-end gap-2 px-4 py-4">
            <button type="button" wire:click="edit({{ $division->id }})" title="Edit Divisi"
            ...
            <button type="button" wire:click="confirmDeletion({{ $division->id }}, '{{ $division->name }}')" title="Hapus Divisi"
