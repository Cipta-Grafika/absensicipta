      ...
      @foreach ($jobTitles as $jobTitle)
        <tr>
          ...
          <td class="relative flex justify-end gap-2 px-4 py-4">
            <button type="button" wire:click="edit({{ $jobTitle->id }})" title="Edit Jabatan"
            ...
            <button type="button" wire:click="confirmDeletion({{ $jobTitle->id }}, '{{ $jobTitle->name }}')" title="Hapus Jabatan"
