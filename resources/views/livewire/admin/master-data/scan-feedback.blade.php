<div>
                ...
                <tr class="hover:bg-gray-50 dark:hover:bg-gray-750">
                  ...
                  <td class="whitespace-nowrap px-6 py-4 text-center text-sm font-medium">
                    <div class="flex items-center justify-center gap-2">
                      <button type="button" wire:click="edit('{{ $fb->id }}')" title="Edit Ucapan"
                      ...
                      <button type="button" wire:click="confirmDelete('{{ $fb->id }}')" title="Hapus Ucapan"
  ...
  <x-confirmation-modal wire:model.live="showDeleteModal">
    ...
    <x-slot name="footer">
      ...
      <x-secondary-button class="ms-2" wire:click="$set('showDeleteModal', false)">
        Batal
      </x-secondary-button>
    </x-slot>
