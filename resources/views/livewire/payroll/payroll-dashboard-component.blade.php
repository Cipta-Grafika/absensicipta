  ...
  <div class="relative flex items-center justify-between">
    <div>
      ...
      <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
        Ringkasan & Statistik Penggajian Karyawan Cipta Grafika
      </p>
    </div>
...
<div class="py-0 sm:py-6" x-data="{ filterOpen: false }" @open-filter.window="filterOpen = true">
  <div class="w-full sm:px-6 lg:px-8 space-y-6">
    ...
    <div class="mb-6 grid grid-cols-1 gap-6">
      <div class="overflow-hidden rounded-2xl border border-sky-200/80 bg-white/70 backdrop-blur-xl shadow-2xl shadow-black/5 dark:border-gray-800/80 dark:bg-gray-900/70">
