    ...
    <div class="relative flex items-center justify-between">
      <div>
        <h2 class="text-xl font-bold leading-tight text-gray-800 dark:text-gray-200">
          Import & Export Metode Pembayaran
        </h2>
        <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
          Kelola Data Rekening Bank & Metode Pembayaran Gaji Karyawan via Excel/CSV
        </p>
      </div>
      <a href="{{ asset('excel/payment_methods.xlsx') }}" download class="inline-flex items-center px-4 py-2 border border-transparent rounded-xl font-semibold text-xs text-white transition-all duration-150 bg-sky-500 hover:bg-sky-600 focus:bg-sky-600 active:bg-sky-700 shadow-md shadow-sky-500/20">
