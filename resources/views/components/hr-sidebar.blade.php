...
<aside class="hr-sidebar-container fixed top-[7.5rem] left-0 bottom-0 z-30 w-64 hidden lg:flex flex-col bg-white dark:bg-gray-800 border-r border-gray-200/80 dark:border-gray-700/80 select-none transition-all duration-300 ease-in-out"
  ...
  <div class="flex-1 overflow-y-auto px-3.5 py-4 space-y-1">
    ...
    <a href="{{ route('hr.dashboard') }}"
       class="group flex items-center gap-3 px-3 py-2.5 text-xs font-semibold rounded-xl transition-all duration-150 {{ $active ? 'bg-sky-50 text-sky-600 dark:bg-sky-950/60 dark:text-sky-400 font-bold' : 'text-gray-600 hover:bg-gray-100/80 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700/60 dark:hover:text-gray-200' }}">
      <x-heroicon-o-home class="h-4 w-4 shrink-0 {{ $active ? 'text-sky-600 dark:text-sky-400' : 'text-gray-400 group-hover:text-gray-600 dark:text-gray-400 dark:group-hover:text-gray-300' }}" />
    ...
    @if (Auth::user()?->isSuperadmin)
      ...
      <a href="{{ route('hr.barcodes') }}"
         class="group flex items-center gap-3 px-3 py-2.5 text-xs font-semibold rounded-xl transition-all duration-150 {{ $active ? 'bg-sky-50 text-sky-600 dark:bg-sky-950/60 dark:text-sky-400 font-bold' : 'text-gray-600 hover:bg-gray-100/80 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700/60 dark:hover:text-gray-200' }}">
        <x-heroicon-o-qr-code class="h-4 w-4 shrink-0 {{ $active ? 'text-sky-600 dark:text-sky-400' : 'text-gray-400 group-hover:text-gray-600 dark:text-gray-400 dark:group-hover:text-gray-300' }}" />
    ...
    <a href="{{ route('hr.attendances') }}"
       class="group flex items-center gap-3 px-3 py-2.5 text-xs font-semibold rounded-xl transition-all duration-150 {{ $active ? 'bg-sky-50 text-sky-600 dark:bg-sky-950/60 dark:text-sky-400 font-bold' : 'text-gray-600 hover:bg-gray-100/80 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700/60 dark:hover:text-gray-200' }}">
      <x-heroicon-o-calendar-days class="h-4 w-4 shrink-0 {{ $active ? 'text-sky-600 dark:text-sky-400' : 'text-gray-400 group-hover:text-gray-600 dark:text-gray-400 dark:group-hover:text-gray-300' }}" />
    ...
    <a href="{{ route('hr.replacement-approvals') }}"
       class="group flex items-center gap-3 px-3 py-2.5 text-xs font-semibold rounded-xl transition-all duration-150 {{ $active ? 'bg-sky-50 text-sky-600 dark:bg-sky-950/60 dark:text-sky-400 font-bold' : 'text-gray-600 hover:bg-gray-100/80 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700/60 dark:hover:text-gray-200' }}">
      <x-heroicon-o-arrow-path class="h-4 w-4 shrink-0 {{ $active ? 'text-sky-600 dark:text-sky-400' : 'text-gray-400 group-hover:text-gray-600 dark:text-gray-400 dark:group-hover:text-gray-300' }}" />
    ...
    <a href="{{ route('hr.overtime-approvals') }}"
       class="group flex items-center gap-3 px-3 py-2.5 text-xs font-semibold rounded-xl transition-all duration-150 {{ $active ? 'bg-sky-50 text-sky-600 dark:bg-sky-950/60 dark:text-sky-400 font-bold' : 'text-gray-600 hover:bg-gray-100/80 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700/60 dark:hover:text-gray-200' }}">
      <x-heroicon-o-fire class="h-4 w-4 shrink-0 {{ $active ? 'text-sky-600 dark:text-sky-400' : 'text-gray-400 group-hover:text-gray-600 dark:text-gray-400 dark:group-hover:text-gray-300' }}" />
    ...
    <a href="{{ route('hr.employees') }}"
       class="group flex items-center gap-3 px-3 py-2.5 text-xs font-semibold rounded-xl transition-all duration-150 {{ $active ? 'bg-sky-50 text-sky-600 dark:bg-sky-950/60 dark:text-sky-400 font-bold' : 'text-gray-600 hover:bg-gray-100/80 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700/60 dark:hover:text-gray-200' }}">
      <x-heroicon-o-user-group class="h-4 w-4 shrink-0 {{ $active ? 'text-sky-600 dark:text-sky-400' : 'text-gray-400 group-hover:text-gray-600 dark:text-gray-400 dark:group-hover:text-gray-300' }}" />
    ...
    <div>
      <button type="button" @click="openJadwal = !openJadwal"
              class="group flex w-full items-center justify-between px-3 py-2.5 text-xs font-semibold rounded-xl transition-all duration-150 {{ $isJadwalActive ? 'bg-gray-100/80 dark:bg-gray-700/80 text-gray-900 dark:text-white' : 'text-gray-600 hover:bg-gray-100/80 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700/60 dark:hover:text-gray-200' }}">
        <div class="flex items-center gap-3 truncate">
          <x-heroicon-o-clock class="h-4 w-4 shrink-0 {{ $isJadwalActive ? 'text-sky-600 dark:text-sky-400' : 'text-gray-400 group-hover:text-gray-600 dark:text-gray-400 dark:group-hover:text-gray-300' }}" />
      ...
      <div x-show="openJadwal" x-collapse x-cloak class="mt-1 ml-4 pl-3 border-l-2 border-gray-200 dark:border-gray-700 space-y-1">
        ...
        <a href="{{ route('hr.work-schedules') }}"
           class="group flex items-center justify-between px-3 py-2 text-[11px] font-medium rounded-lg transition-all duration-150 {{ $active ? 'bg-sky-50 text-sky-600 dark:bg-sky-950/60 dark:text-sky-400 font-bold' : 'text-gray-500 hover:bg-gray-100/60 hover:text-gray-900 dark:text-gray-400 dark:hover:bg-gray-700/40 dark:hover:text-gray-200' }}">
    ...
    <div>
      <button type="button" @click="openMaster = !openMaster"
        ...
        <div class="flex items-center gap-3 truncate">
          <x-heroicon-o-circle-stack class="h-4 w-4 shrink-0 {{ $isMasterActive ? 'text-sky-600 dark:text-sky-400' : 'text-gray-400 group-hover:text-gray-600 dark:text-gray-400 dark:group-hover:text-gray-300' }}" />
    ...
    <div>
      <button type="button" @click="openImport = !openImport"
        ...
        <div class="flex items-center gap-3 truncate">
          <x-heroicon-o-arrow-down-tray class="h-4 w-4 shrink-0 {{ $isImportActive ? 'text-sky-600 dark:text-sky-400' : 'text-gray-400 group-hover:text-gray-600 dark:text-gray-400 dark:group-hover:text-gray-300' }}" />
