    ...
    <tbody>
      @forelse ($approvals as $approval)
        <tr>
          ...
          <td>{{ $approval->employee->name ?? '-' }}</td>
          <td>{{ $approval->employee->nip ?? '-' }}</td>
          <td>{{ \Carbon\Carbon::parse($approval->overtime_date)->format('d M Y') }}</td>
          <td class="text-center">{{ \Carbon\Carbon::parse($approval->start_time)->format('H:i') }} - {{ \Carbon\Carbon::parse($approval->end_time)->format('H:i') }}</td>
          <td>{{ $approval->duration_hours }} Jam</td>
