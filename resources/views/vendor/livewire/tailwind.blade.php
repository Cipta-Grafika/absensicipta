...
$scrollIntoViewJsSnippet = "window.scrollTo({ top: 0, behavior: 'smooth' });";
@endphp
                                    ...
                                    <span wire:key="paginator-{{ $paginator->getPageName() }}-page{{ $page }}">
                                        @if ($page == $paginator->currentPage())
                                            <span aria-current="page">
                                                <span class="relative z-10 inline-flex items-center px-4 py-2 -ml-px text-sm font-bold text-white bg-blue-500 border border-blue-500 cursor-default leading-5 dark:bg-blue-600 dark:border-blue-600">{{ $page }}</span>
                                            </span>
                                        @else
